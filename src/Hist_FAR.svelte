<script>
    ...
    function Histogram(data, 
            {
                ...
                thresholds = 0, // approximate number of bins to generate, or threshold function
                marginTop = 20, // top margin, in pixels
                marginRight = 20, // right margin, in pixels
                marginBottom = 20, // bottom margin, in pixels
                marginLeft = 40, // left margin, in pixels
                width = 0, // outer width of chart, in pixels
                height = 0, // outer height of chart, in pixels
        ...
        const svg = d3.select("div#far-chart").append("svg");
        ...
        g.append('line')
            ...
            .attr("x1", xScale(vline) + insetLeft )
            .attr("y1", marginBottom)
            .attr("x2", xScale(vline) + insetLeft )
    ...
    afterUpdate(() => {
        ...
        document.getElementById('far-chart').innerHTML = "";
